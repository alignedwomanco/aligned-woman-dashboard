  ...
  try {
    ...
    const lines = grantCommunityHost && group
      ? [
          ...
          `The host guide walks you through it, including what you can see as a host, what we ask of you, and how join requests and reports work. Read it before you open the doors.`, ``,
          `Read the guide (log in first): ${APP_ORIGIN}/host-guide`, ``,
