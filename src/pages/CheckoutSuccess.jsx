...
function PrimaryLink({ href, onClick, children }) {
  return (
    <a
      href={href}
      onClick={onClick}
      className="inline-flex items-center justify-center rounded-full bg-awburg-core text-white font-body text-sm tracking-wide px-8 py-3 transition-opacity hover:opacity-90"
    >
      {children}
    </a>
  );
      ...
      <div className="w-full max-w-md text-center">
        ...
        {status === "granted" && (
          <div>
            ...
            <PrimaryLink href={DASHBOARD_PATH}>Enter the Blueprint</PrimaryLink>
          </div>
        )}
        ...
        {status === "conflict" && (
          <div>
            ...
            <div className="flex flex-col items-center gap-4">
              <PrimaryLink href={DASHBOARD_PATH}>Go to sign in</PrimaryLink>
              <a
        ...
        {status === "unconfirmed" && (
          <div>
            ...
            <div className="flex flex-col items-center gap-4">
              <PrimaryLink onClick={() => setAttempt((a) => a + 1)}>
                Try again
              </PrimaryLink>
              <a
                href={"mailto:" + SUPPORT_EMAIL}
