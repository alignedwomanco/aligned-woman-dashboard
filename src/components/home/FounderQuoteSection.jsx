      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        ...
        >
          ...
          {!embedError ? (
            ...
            <div style={{ paddingBottom: "56.25%", position: "relative", borderRadius: 8, overflow: "hidden", background: "rgba(0,0,0,0.4)" }}>
              <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
                ...
                <a
                  ...
                  style={{ background: "rgb(196,132,122)", color: "#fff", fontSize: 11, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", padding: "14px 32px", borderRadius: 100, textDecoration: "none" }}
                >
                  Watch on YouTube →
                </a>
              </div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          style={{ fontFamily: "Montserrat, sans-serif", fontSize: 10, fontWeight: 600, letterSpacing: "0.28em", textTransform: "uppercase", color: "rgba(196,134,108,0.5)", textDecoration: "none" }}
        >
