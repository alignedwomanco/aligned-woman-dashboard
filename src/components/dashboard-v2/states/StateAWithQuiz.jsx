      ...
      <div className="relative rounded-xl mb-6 shadow-sm overflow-hidden" style={{ border: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <div className="relative p-5 md:p-6" style={{ zIndex: 2 }}>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <button onClick={() => navigate(continueUrl)} className="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white text-xs font-bold tracking-eyebrow uppercase py-3 px-6 rounded-full transition-all duration-200 flex-shrink-0 border border-white/30 animate-[pulse_12s_ease-in-out_infinite]">
